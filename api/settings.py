...
GRAPHQL_KATSU_API = os.getenv("GRAPHQL_KATSU_API", "http://candigv2_tyk_1:8080/katsu/api")
GRAPHQL_CANDIG_SERVER = os.getenv("GRAPHQL_CANDIG_SERVER", "http://candigv2_tyk_1:8080/candig")
